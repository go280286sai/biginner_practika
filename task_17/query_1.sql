select avg(price) from public.users inner join public.carts on public.users.user_id=users_user_id inner join public."'Order'"
...
public.categories.category_id=public.products.category_id where status_name='Finished' 